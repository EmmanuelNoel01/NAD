...
<!--      <li style="display: inline; float: left; background-color: #dddddd">
        ...
        <div>
            <!-- register form -->
            <form action="/MarketingCampaign/Calculate" method="post" style="border: 3px solid #f1f1f1;">
               ...
               <div style="padding: 20px 70px 20px 70px; width: 50%; margin: auto;">
                   <div style="background-color:#f1f1f1; padding:30px;"> 
                        ...
                        <button href="upload2.jsp" type="submit"
                        style="
                           border-radius: 20px;
                           ...
                           width: 50%;" value="Register">        
                            <a href="upload2.jsp">Calculate</a></button>
                        </br>
                        </br>
                   </div>
               </div>
            ...
            <form action="/MarketingCampaign/Calculate" method="get" style="border: 3px solid #f1f1f1;">
               ...
               <div style="padding: 20px 70px 20px 70px; width: 50%; margin: auto;">
                   <div style="background-color:#f1f1f1; padding:30px;"> 
                        ...
                        <input type="number" placeholder="" name="ltp" required style="width: 100%; padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; box-sizing: border-box;">
                        </br>
                        <label for="agentName"><b>Enter Number of Employees Working on The Mid Term Products</b></label>
                        </br>
                        <input type="number" placeholder="" name="mtp" required style="width: 100%; padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; box-sizing: border-box;">
                        </br>
                        <label for="agentName"><b>Enter Number of Employees Working on The Short Term Products</b></label>
                        </br>
                        <input type="number" placeholder="" name="stp" required style="width: 100%; padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; box-sizing: border-box;">
                        </br>
                        </br>
                        <button type="submit"
                        style="
        ...
        <div class="wrap" style="align-content: center; padding-top: 30px; padding-bottom: 30px;">
            <div style="text-align: center; ">
                <div>
                    <h2 style="font-size:25px; color: black; margin-bottom: 10px;">STAFF/EMPLOYEE IN EACH PRODUCT LINE</h2>
                </div>
                <div style="width: 100%;">
            ...
            <table id="myTable" class="responsive-table"> 
                <tr>
                    <th><b>Long-term Products Staff </b></th>
                    <th><b>Mid-term Products Staff </b></th>
                    <th><b>Short-term Products Staff </b></th>
                </tr>
                <tr>
                  <td>Total Number of Staff: 10</td>
                  <td>Total Number of Staff: 20</td>
                  <td>Total Number of Staff: 10</td>
